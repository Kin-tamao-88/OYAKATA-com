          ...
          <div className="flex flex-col gap-12 lg:flex-row lg:gap-16 lg:items-start">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-7">
                <span className="text-[#D4A820] font-black text-[13px]">06</span>
                <div className="w-px h-5 bg-[#ccc]" />
                <span className="text-[#555] text-[13px]">親方ドットコムの仕組み</span>
              </div>
            ...
            {/* ── Right: 3 Steps ── */}
            <div className="w-full lg:w-[44%] lg:shrink-0 lg:pt-[56px]">
              {steps.map((step, i) => (
                <div key={i}>
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex-1">
                      <div
                        className="w-[72px] h-[72px] lg:w-[80px] lg:h-[80px] rounded-full border-2 border-[#e0e0e0] flex items-center justify-center mb-3"
                        style={step.highlight ? { backgroundColor: "#fff9e6", borderColor: "#D4A820" } : {}}
                      >
                        {step.icon}
                      </div>
                      <h3 className="text-[#1a1a1a] font-black text-[18px] lg:text-[20px] mb-2">{step.title}</h3>
                      {step.highlight && <div className="w-14 h-[3px] bg-[#D4A820] mb-2" />}
                  ...
                  {i < steps.length - 1 && (
                    <div className="flex justify-start pl-4 py-3">
                      <svg width="18" height="26" viewBox="0 0 20 28" fill="none" aria-hidden="true">
                        <path d="M10 0 L10 22 M4 16 L10 22 L16 16" stroke="#D4A820" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                    </div>
                  )}
                </div>
