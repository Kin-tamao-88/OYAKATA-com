...
const cards = [
  ...
  },
  {
    num: "03",
    title: "広告を出せない",
    body: "広告や集客に予算をかけられず、新しい出会いが生まれない。",
    gold: false,
  ...
  },
  {
    num: "04",
    title: "さらに仕事が減る",
    body: "出会いがないから元請け案件も増えず、また仕事が減っていく。",
    gold: false,
    icon: <img src={iconConnect} alt="" className="w-[144px] h-[144px] object-contain" aria-hidden="true" />,
  },
];
    ...
    <section className="bg-white py-14 lg:py-[80px]">
      <div className="max-w-[1280px] mx-auto px-5 lg:px-[68px]">
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-10 mb-12 lg:mb-16">
          ...
          {/* Right: Photo */}
          <div className="relative w-full lg:w-[53%] lg:shrink-0">
            <img
              src={painWorker}
              alt="悩む工事業者"
            ...
            <div className="absolute top-4 right-4 bg-white border border-[#ddd] font-bold text-[#1a1a1a] text-[14px] leading-snug px-4 py-2">
              このままだと、<br />
              先が見えない…
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3 lg:hidden">
          {cards.map((c, i) => (
            <div key={i} className="border border-[#ccc] flex flex-col overflow-hidden">
              ...
              <div className="flex-1 bg-white flex flex-col items-center justify-center px-3 py-4">
                <div className="mb-3 scale-75 origin-top">{c.icon}</div>
