  ...
  return (
    <>
      ...
      <section className="bg-[#111111] py-7 lg:py-9 relative overflow-hidden">
        ...
        {/* 上端ゴールドライン */}
        <div className="absolute top-0 left-0 right-0 h-1 bg-[#D4A820]/80" />
        ...
        <div className="max-w-[1280px] mx-auto px-5 lg:px-[68px] relative">
          <div className="grid grid-cols-2 gap-8 lg:grid-cols-4 lg:gap-0 lg:divide-x lg:divide-white/10">
            ...
            <div className="text-center lg:px-6">
              <span className="block text-[#D4A820] font-black text-[11px] tracking-[0.2em] mb-5">01</span>
              ...
              <h3 className="text-white font-black text-[17px] lg:text-[20px] mb-2">戦略設計</h3>
              <p className="text-white/65 text-[13px] lg:text-[15px] leading-[1.9]">工事業界の市場・競合・顧客を分析し、元請け案件獲得に特化した集客戦略を設計します。</p>
            </div>

            {/* 広告運用 */}
            <div className="text-center lg:px-6">
              <span className="block text-[#D4A820] font-black text-[11px] tracking-[0.2em] mb-5">02</span>
              <div className="flex justify-center mb-4">
                <svg width="72" height="72" viewBox="0 0 80 80" fill="none" aria-hidden="true">
              ...
              <h3 className="text-white font-black text-[17px] lg:text-[20px] mb-2">広告運用</h3>
              <p className="text-white/65 text-[13px] lg:text-[15px] leading-[1.9]">リスティング広告・SNS広告を最適に運用し、問い合わせの最大化を実現します。</p>
            </div>

            {/* データ分析 */}
            <div className="text-center lg:px-6">
              <span className="block text-[#D4A820] font-black text-[11px] tracking-[0.2em] mb-5">03</span>
              <div className="flex justify-center mb-4">
                <svg width="72" height="72" viewBox="0 0 80 80" fill="none" aria-hidden="true">
              ...
              <h3 className="text-white font-black text-[17px] lg:text-[20px] mb-2">データ分析</h3>
              <p className="text-white/65 text-[13px] lg:text-[15px] leading-[1.9]">問い合わせ・広告・LPを多角的に分析し、課題を明確にして改善につなげます。</p>
            </div>

            {/* 改善提案・実行 */}
            <div className="text-center lg:px-6">
              <span className="block text-[#D4A820] font-black text-[11px] tracking-[0.2em] mb-5">04</span>
              <div className="flex justify-center mb-4">
                <svg width="72" height="72" viewBox="0 0 80 80" fill="none" aria-hidden="true">
              ...
              <h3 className="text-white font-black text-[17px] lg:text-[20px] mb-2">改善提案・実行</h3>
